...
if(isset($_POST['submit_search_borrowdetails'])){ //when submit button is click
    ...
    $sql = "SELECT Borrow_Status, Date_Return FROM borrowdetails WHERE Book_ID = '$book_ID' AND Borrow_ID = '$borrow_ID' ";
...
<div class="modal">
    <div class="modal_content2">
        <form action="UpdateBorrowDetails.html" method="post">
            ...
            Update Date Return : <input class="input-fields" type="datetime-local" name="date_return" value="<?php 
                                  if ($datestr != "1970-01-01T01:00:00"){echo date('Y-m-d\TH:i:s', strtotime($row['Date_Return']));}  ?>" required>
            <br><br><br><br>
